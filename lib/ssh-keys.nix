...
{ lib }: {
  ...
  devOps = {
    craige = [
      "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIDtjE0YstRzlh+Zhlj03th9DYOkMqJ5xHUcderBq151K craige@dionach"
      "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIEIiZ8OoGg1ksbrvG1zCWZ5m/TGBr79zZEp08m2ebkuS craige@cuallaidh"
    ];
    jbgi = [
    ...
    manveru = [
      "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIMXdgLi9zYP+aS+hpuC/Hmy1yH+wa8O1m66730oNuHuj manveru@tau"
      "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIDm3tqNg9Van7hGhWM+b0AFXni40Zp5U773R2SUvdSIv manveru@kappa"
      "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIBJl7CqUC5liPI3cuou7Ik+rNM5s8cdI3Zpas9Tqeplt manveru@omikron"
    ];
    michael = [
    ...
    rodney = [
      "ssh-rsa  cardno:000611300236"
    ];
    sam = [
    ...
    charles = [
      "ecdsa-sha2-nistp256 AAAAE2VjZHNhLXNoYTItbmlzdHAyNTYAAAAIbmlzdHAyNTYAAABBBJBRhsdeDa6/lvaEOWKPLFJnc2aNsBE+aCiWh+PTVq5uAEPWRh6HdJfj90jXuLGprdRanFjV0vAO2xL3gB5wRxE= cmorgan@Marius.local"
    ];
  };
  ...
  csl-developers = {
    ...
    andreas = [
      "ssh-rsa  andreas_triantafyllos@hotmail.com"
    ];
    avieth = [
      "ssh-rsa  Alex Vieth"
    ];
    ben = [
      "ssh-rsa  ben@office"
    ];
    coot = [
      "ssh-rsa "
    ];
    dshevchenko = [
      "ssh-rsa  me@dshevchenko.biz"
    ];
    erikd = [
      "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIBz3TPhcOjxpnE6aTD6GNgXF2eKcOLdlp3ObtixhT4yN erikd@ada"
    ];
    jbgi = [
      "ssh-rsa  jbgi@howard"
    ];
    ...
    karknu = [
      "ssh-rsa  karknu@iohk"
    ];
    ksaric = [
      "ssh-rsa  ksaric@ksaric-H61M-S2V-B3"
    ];
    lars = [
      "ssh-rsa  brunjlar@gmail.com"
    ];
    mhueschen = [
      "ssh-rsa  mhueschen@iohk"
    ];
    philipp = [
      "ssh-rsa  philipp@philipps-mbp.fritz.box"
    ];
    pkelly = [
      "ssh-rsa  patrick.kelly@iohk.io"
    ];
    vasilis = [
    ...
    david = [
      "ssh-rsa "
    ];
    dorin = [
      "ssh-rsa  dorin@lenovo"
    ];
    robcohen = [
      "ssh-rsa  Minx"
    ];
  };
  ...
  mantis-devOps = {
    ...
    lukasz = [
      "ssh-rsa  lukas.gasior@gmail.com"
    ];
    radek = [
      "ssh-rsa  radek@scalac.io"
    ];
  };
  ...
  mantis-developers = {
    alan = [
      "ssh-rsa AAAAB3NzaC1yc2EAAAADAQABAAABAQDF+B5wsIXGPdlAxdyqmXk+YBKOBcKgZQ8rVaKLmhDwtUud16210oznwHbccySxxweEAyFfvgMWh9u7XhXTXcF886Pl1YFFCTcbJmxN LKXVkmMqiM0E9/zd5OpxmqbPYCpLwsL+U/V4DOT0JmvdmJo8uKfwmXp+PoVd5vAeDjeeR/YUC5zcc68orFq1jt1gC62k1E/0DX3tOpGcvQVPCe5od26A9GIGfHwnuWYDX8ku7WCCALrm FGv8FiL2sC1RzTRdCi+bdA4YWyLpa54nZ5IzxIPvFhe/LAcfdDOi2B9/1ICUc7Y++BFjYFlkqV0//EOmsDHv53pTCykSZoS2DIqF alan@dreadnought"
    ];
  };
  ...
  remoteBuilderKeys = {
    hydraBuildFarm = [
      "ssh-rsa  buildfarm"
      "ssh-rsa  hydra@mantis-hydra.aws.iohkdev.io"
    ];
    rodney = [
      "ssh-rsa  rodney-remote-build"
    ];
    michael = [
      "ssh-rsa  root@amd-nixos"
    ];
  };
  ...
  allKeysFrom = keys: lib.concatLists (lib.attrValues keys);
}
