...
in lib // (rec {
  ...
  devKeys = [ volhovmKey georgeeeKey gromakKey gromak2Key flyingleafeKey flyingleafe2Key martoonKey domenKey alanKey jakeKey neongreenKey dshevchenkoKey larsKey philippKey shershKey fersel1Key fersel2Key niklasFPCKey kosergeKey ksaric sectore michaelKey narylKey pva701Key pva7012Key akegaljKey alfredoKey hithrocKey rodneyKey vasilisKey andreasKey ];
