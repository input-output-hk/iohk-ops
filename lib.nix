...
in lib // (rec {
  ...
  devKeys = with ssh_keys; [ volhovmKey georgeeeKey gromakKey gromak2Key flyingleafeKey flyingleafe2Key martoonKey domenKey alanKey jakeKey neongreenKey dshevchenkoKey larsKey philippKey shershKey fersel1Key fersel2Key niklasFPCKey kosergeKey ksaric sectore michaelKey narylKey pva701Key akegaljKey alfredoKey];

  devOpsKeys = with ssh_keys; [ domenKey georgeeeKey jakeKey kosergeKey michaelKey ];
})
