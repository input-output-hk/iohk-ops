...
in lib // (rec {
  ...
  devKeys = [ domenKey alanKey jakeKey dshevchenkoKey larsKey philippKey kosergeKey ksaric sectore michaelKey akegaljKey alfredoKey rodneyKey vasilisKey andreasKey samKey alexandersKey ];

  devOpsKeys = [ domenKey jakeKey jake2Key kosergeKey michaelKey rodneyKey samKey ];
})
