...
in lib // (rec {
  ...
  devKeys = [ volhovmKey georgeeeKey gromakKey gromak2Key flyingleafeKey flyingleafe2Key martoonKey domenKey alanKey jakeKey neongreenKey dshevchenkoKey larsKey philippKey shershKey kosergeKey ksaric sectore michaelKey narylKey pva701Key akegaljKey alfredoKey hithrocKey rodneyKey vasilisKey andreasKey samKey alexandersKey ];

  devOpsKeys = [ domenKey georgeeeKey jakeKey jake2Key kosergeKey michaelKey rodneyKey samKey ];
})
