...
cabal2nix https://github.com/input-output-hk/cardano-sl.git --no-check --revision 4234d66a55c5310be2751eeffbdd0672e9ab9fba > cardano-sl.nix
...
cabal2nix https://github.com/avieth/network-transport-tcp.git --no-check --revision 15847920ac1a32ada237e5a00ac4f56f3ca421a7 > network-transport-tcp.nix
...
cabal2nix https://github.com/input-output-hk/cardano-sl-explorer.git --no-check --revision 3ff32b51fef5a89722598a65acc47218edd44683 > cardano-sl-explorer.nix
