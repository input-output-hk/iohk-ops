...
self: {
      ...
      servant-server_0_10 = callPackage ({ Cabal, aeson, attoparsec, base, base-compat, base64-bytestring, bytestring, containers, directory, exceptions, filepath, http-api-data, http-types, mkDerivation, monad-control, mtl, network, network-uri, resourcet, safe, servant_0_10, split, stdenv, string-conversions, system-filepath, text, transformers, transformers-base, transformers-compat, wai, wai-app-static, warp, word8 }:
      mkDerivation {
      ...
      servant-swagger-ui = callPackage ({ base, blaze-markup, bytestring, directory, file-embed, filepath, http-media, mkDerivation, servant-blaze, servant-server_0_10, servant-swagger_1_1_2_1, servant_0_10, stdenv, swagger2, template-haskell, text, transformers, transformers-compat, wai-app-static }:
      mkDerivation {
      ...
      servant-swagger_1_1_2_1 = callPackage ({ Cabal, QuickCheck, aeson, base, bytestring, cabal-doctest, directory, filepath, hspec, http-media, insert-ordered-containers, lens, mkDerivation, servant_0_10, stdenv, swagger2, text, unordered-containers }:
      mkDerivation {
      ...
      servant_0_10 = callPackage ({ Cabal, aeson, attoparsec, base, base-compat, bytestring, case-insensitive, directory, filepath, http-api-data, http-media, http-types, mkDerivation, mmorph, mtl, natural-transformation, network-uri, stdenv, string-conversions, text, vault }:
      mkDerivation {
          pname = "servant";
          version = "0.10";
