...
self: {
      ...
      mkDerivation {
          ...
          src = fetchgit {
            ...
            sha256 = "0n3m519aqalv1ls536wayxm4zap4lrrsyfnvhig1ixbi8phwpnrm";
            rev = "d56751de03fb7561a731b31a39ce0073966b102e";
          };
          isLibrary = true;
          isExecutable = true;
          libraryHaskellDepends = [
