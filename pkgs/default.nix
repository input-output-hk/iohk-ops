...
self: {
      ...
      mkDerivation {
          ...
          revision = "1";
          editedCabalFile = "f7aa0ead359baf219ef08131a4285439bec0b48106a89123afd2348a07274b94";
          libraryHaskellDepends = [
            aeson
            base
            bytestring
