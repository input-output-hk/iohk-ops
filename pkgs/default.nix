...
self: {
      ...
      mkDerivation {
          ...
          src = fetchgit {
            ...
            sha256 = "1yidx7302i15hvhiws0cc5di0s9c5igjiwiqfzgal8h6s52pggk0";
            rev = "ec622aa0b507645897d08c8851f5d2a65991a608";
          };
          isLibrary = true;
          isExecutable = true;
          libraryHaskellDepends = [
