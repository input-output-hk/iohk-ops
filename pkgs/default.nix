...
self: {
      ...
      cardano-sl = callPackage ({ IfElse, QuickCheck, acid-state, aeson, ansi-terminal, ansi-wl-pprint, async, base, base58-bytestring, base64-bytestring, binary, binary-conduit, binary-orphans, bytestring, cardano-crypto, cardano-report-server, cardano-sl-core, cardano-sl-db, cardano-sl-godtossing, cardano-sl-infra, cardano-sl-lrc, cardano-sl-ssc, cardano-sl-txp, cardano-sl-update, cereal, conduit, containers, cpphs, cryptonite, cryptonite-openssl, data-default, deepseq, deriving-compat, digest, directory, dlist, ed25519, ekg, ekg-core, ekg-statsd, ether, exceptions, fetchgit, file-embed, filelock, filepath, focus, formatting, generic-arbitrary, gitrev, hashable, http-client, http-client-tls, http-conduit, http-types, kademlia, lens, lifted-async, list-t, log-warper, lrucache, memory, mkDerivation, mmorph, monad-control, monad-loops, mono-traversable, mtl, neat-interpolation, network-info, network-transport, network-transport-tcp, node-sketch, optparse-applicative, optparse-simple, parsec, plutus-prototype, pvss, quickcheck-instances, random, reflection, resourcet, rocksdb-haskell, safecopy, serokell-util, servant, servant-multipart, servant-server, stdenv, stm, stm-containers, string-qq, tagged, template-haskell, temporary, text, text-format, th-lift-instances, time, time-units, transformers, transformers-base, transformers-lift, turtle, universum, unix, unordered-containers, vector, versions, wai, wai-extra, wai-websockets, warp, warp-tls, websockets, wreq, yaml }:
      mkDerivation {
          pname = "cardano-sl";
          version = "0.5.1";
          src = fetchgit {
            url = "https://github.com/adinapoli-iohk/cardano-sl.git";
            sha256 = "02qlp4myagxj5n9lwww4sv1vql80850wvkxsj0zpi7hwi27d1f55";
            rev = "68e7f77da51c2d1370ea755eee409b41be5e20c0";
          };
          isLibrary = true;
          isExecutable = true;
          libraryHaskellDepends = [
      ...
      cardano-sl-infra = callPackage ({ QuickCheck, aeson, base, base64-bytestring, binary, bytestring, cardano-report-server, cardano-sl-core, cardano-sl-db, containers, cpphs, data-default, directory, either, ether, exceptions, fetchgit, filepath, formatting, generic-arbitrary, hashable, kademlia, lens, list-t, log-warper, mkDerivation, mmorph, monad-control, mtl, network-info, network-transport, network-transport-tcp, node-sketch, optparse-simple, parsec, reflection, serokell-util, stdenv, stm, stm-containers, tagged, template-haskell, temporary, text, text-format, time, time-units, transformers, transformers-base, transformers-lift, universum, unordered-containers, wreq }:
      mkDerivation {
      ...
      cardano-sl-tools = callPackage ({ Glob, QuickCheck, aeson, ansi-wl-pprint, array, async, attoparsec, base, bytestring, cardano-report-server, cardano-sl, cardano-sl-core, cardano-sl-infra, cardano-sl-txp, containers, cpphs, cryptonite, data-default, directory, ed25519, fetchgit, filepath, foldl, formatting, kademlia, lens, lifted-async, log-warper, mkDerivation, optparse-applicative, optparse-simple, optparse-text, parsec, process, purescript-bridge, random, random-shuffle, serokell-util, servant, servant-multipart, servant-server, servant-swagger, servant-swagger-ui, stdenv, stm, string-qq, swagger2, system-filepath, tar, text, time, time-units, turtle, universum, unordered-containers, vector, wreq }:
      mkDerivation {
      ...
      kademlia = callPackage ({ MonadRandom, base, binary, bytestring, containers, contravariant, cryptonite, data-default, errors, extra, fetchgit, memory, mkDerivation, mtl, network, random, random-shuffle, stdenv, stm, store, time, transformers, transformers-compat }:
      mkDerivation {
          pname = "kademlia";
          version = "1.1.0.1";
          src = fetchgit {
            url = "https://github.com/serokell/kademlia.git";
            sha256 = "0jka84k9j5gp20mbd49ns5sbya6m0vdkpripmfl0yxqbcjblifcv";
            rev = "43d58d72b0fb2e3931746b54237f3a249bc5553e";
          };
          isLibrary = true;
          isExecutable = true;
          libraryHaskellDepends = [
      ...
      node-sketch = callPackage ({ aeson, async, attoparsec, base, binary, bytestring, containers, criterion, data-default, deepseq, ekg, ekg-core, ether, exceptions, fetchgit, formatting, hashable, kademlia, lens, lifted-base, log-warper, mkDerivation, mmorph, monad-control, mtl, mwc-random, network, network-transport, network-transport-tcp, random, resourcet, semigroups, serokell-util, statistics, stdenv, stm, store, tagged, text, text-format, time, time-units, transformers, transformers-base, transformers-lift, universum, unordered-containers, vector }:
      mkDerivation {
          pname = "node-sketch";
          version = "0.1.2.1";
          src = fetchgit {
      ...
      mkDerivation {
          pname = "store";
          version = "0.4.2";
          sha256 = "0sq7lx4whi0blcsnzs5qsryfpdjni47y9z1klac26xw8swgxcksq";
          libraryHaskellDepends = [
            array
            async
            base
