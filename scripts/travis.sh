...
${IOHK_OPS} template --environment production --config 'csl-production.yaml'       'csl-production'       Nodes Explorer ReportServer
${IOHK_OPS} template --environment staging    --config 'csl-staging.yaml'          'csl-staging'          Nodes Explorer ReportServer
${IOHK_OPS} template                          --config 'csl.yaml'                  'csl'                  Nodes Explorer ReportServer
${IOHK_OPS} template --environment staging    --config 'csl-explorer-staging.yaml' 'csl-explorer-staging'       Explorer
${IOHK_OPS} template --environment production --config 'inf.yaml'                  'inf'         Infra
